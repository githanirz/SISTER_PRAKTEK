...
//                InputStream clientIn = client.getInputStream();
    ...
    public static String pertanyaan(){
        ...
        String pertanyaan;
        if(angka == 1){
            pertanyaan = "1#Apa itu TI?";
        }else if(angka == 2){
            pertanyaan = "2#Apa itu ST?";
        }else if(angka == 3){
            pertanyaan = "3#Apa fungsi Mouse?";
        }else if(angka == 4){
            pertanyaan = "4#Apa fungsi TV?";
        }else if(angka == 5){
            pertanyaan = "5#Fungsi Belajar?";
        }else{
            pertanyaan = "6#jam berapa bagusnya tidur";
        }
        return pertanyaan;
    }
    ...
    public static void jawaban(){
        ...
        if(angka == 1){
            jawaban = "1#Jurusan Teknologi Informasi";
        }else if(angka == 2){
            jawaban = "2#Sistem Terdistribusi";
        }else if(angka == 3){
            jawaban = "3#Untuk Mengarahkan kursor";
        }else if(angka == 4){
            jawaban = "4#Untuk Menonton";
        }else if(angka == 5){
            jawaban = "5#Biar pintar";
        }else{
            jawaban = "6#jam 9";
        }
